...
const CreateRecipe = () => {
  ...
  const ingredientsErrorText = isIngredientsError
    ? "Ingredients are required"
    : null;
  const directionsErrorText = isDirectionsError
      ...
      {!loading && (
        <Paper className={classes.paper}>
          ...
          <Button
            ...
            onClick={() =>
              submitRecipe({
                variables: { name, directions, ingredients, imageUrl }
              })
            }
          >
            Create New Recipe
